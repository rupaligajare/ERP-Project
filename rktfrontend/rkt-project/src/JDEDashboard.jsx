...
const JDEDashboard = () => {
    ...
    const demoServices = [
        { title: "Inventory", appId: "P41202", description: "Check real-time stock levels and item locations." },
        { title: "Sales Orders", appId: "P4210", description: "Create and track customer sales orders." },
        { title: "Finance", appId: "P0911", description: "View general ledger and financial reports." },
        { title: "Procurement", appId: "P4310", description: "Manage purchase requisitions and approvals." }
    ];
        ...
        <div className="jde-dashboard-container">
            ...
            <main className="jde-main-content">
                <header className="content-header">
                    ...
                    <p className="env-status">Environment: <strong>DV920 (Demo Mode)</strong></p>
                </header>
                    ...
                    {demoServices.map((service, index) => (
                        <div key={index} className="service-card">
                            ...
                            <button 
                                ...
                                onClick={() => service.appId === 'P41202' ? navigate('/inventory') : null}
                            >
                                Open Module
                            </button>
                        </div>
